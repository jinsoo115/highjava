...
public class VectorTest {
	...
	public static void main(String[] args) {
		...
		// ==> 이전 버전의 프로그램에서도 사용 가능하도록 하기위해 남아 있는 메서드
		v1.addElement("CCC");
		...
		// ==> index번쨰에 '추가할데이터'를 끼워 넣는다. (index는 0부터 시작한다.)
		// ==> 반환값은 없다.
		 v1.add(1,"kkk");
		 System.out.println("v1 ==> " + v1);
		 ...
		 System.out.println("2번재 자료: " + data);
		  ...
		  * 	==> 이 때 제네릭으로 선언될 수 있는 데이터 타입은 '클래스형' 이여야한다.
		  * 		즉, int는 Integer, boolean은 Boolean, char는 Character등으로 대체해서 사용해야 한다.
		 ...
		 v22.add("안녕하세요");
		 //v22.add(123);	// 오류: 다른종류의 데이터를 저장할 수 없다.
