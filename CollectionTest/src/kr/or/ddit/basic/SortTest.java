...
public class SortTest {
	...
	public static void main(String[] args) {
		...
		// Set에 데이터를 추가할 대도 add()메서드를 사용한다.
...
//		System.out.println("Set 데이터 : " + hs1);
		...
		/*
		 * Set의 데이터는 순서(index)가 없기 때문에 List처럼 index로 데이터를 하나씪 불러올 수 없다.
		 * 그래서 데이터를 하나씩 얻기 위해서 Iterator형 객체로 변환해야 한다.
		 * 
		 * - Set형의 데이터를 Iterator형 객체로 변환하는 메서드
		 * 	 ==> iterator()
		 */
		...
		// 	==> Iterator의 포인터가 가리키는 곳 다음 번쨰 위치에 
