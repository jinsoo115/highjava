 ...
 * 	  넣고 싶을 때(내부 정렬 기준) 구현하는 interface이고,
 * - Comparator는 외부에 별도로 정렬 기준을 구현하고 싶을 때 구현 
...
public class ListSortTest1 {
	public static void main(String[] args) {
		...
		// 형식2) Collections.sort(리스트, 외부 정렬기준 객체의 인스턴스);
		//			==> 외부 정렬 기준에 맞게 정렬한다. 
...
// 즉, 외부 정렬 기준 클래스 작성하기 ==> Comparator인터페이스를 구현해야 한다.
