...
public class TcpFileServerSam {
	...
	private void serverStart() {
		// 저장될 폴더정보를 이용한 File객체 생성
		File saveDir = new File("d:/d_other/data");

		if(!saveDir.exists()){ // 저장할 폴더가 없으면 폴더를 생성
		...
		try {
			...
			// 클라이언트가 첫번쨰로 보내온 데이터를 읽어온다. (파일명 읽기)
	...
	public static void main(String[] args) {
		new TcpFileServerSam().serverStart();
	}
