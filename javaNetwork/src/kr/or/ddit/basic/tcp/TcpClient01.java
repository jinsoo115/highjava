...
public class TcpClient01 {
	public static void main(String[] args) throws UnknownHostException, IOException {
		// 현재 자신의 컴퓨터를 나타내는 방법
		// 1) 원래의 IP주소 : 192.168.0.87 (예)
		// 2) 지정된 IP주소 : 127.0.0.1 (어디서든 자기자신 컴퓨터)
		// 3) 원래의 컴퓨터 이름 : DESKTOP-MKJTQ0P (예)
		// 4) 지정된 컴퓨터 이름 : localhost (어디서든 자기자신 컴퓨터 이름)
