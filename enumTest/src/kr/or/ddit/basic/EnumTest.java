 ...
 * 		2) ordinal() ==> 열거형 상수가 정의된 순서값(index값)을 반환했다.
 * 						(0부터 시작)
 * 		3) valueOf("열거형상수명") ==> 지정된 열거형에서
 * 				'열거형상수명'과 일치하는 열거형 상수를 반환한다.
 ...
 *  
 *  		// 열거형의 생성자를 만든다.
 *  		// 열거형의 생성자는 '열거형상수'에 '값들'을 셋팅하는 역할을
 *  		// 수행한다. (열거형 생성자는 묵시적으로 private이다.)
 *  
